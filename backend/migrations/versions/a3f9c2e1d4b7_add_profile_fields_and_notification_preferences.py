...
def upgrade() -> None:
    ...
    op.add_column(
        "doctor_profiles", sa.Column("full_name", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "doctor_profiles", sa.Column("phone", sa.String(length=30), nullable=True)
    )
    op.add_column(
        "doctor_profiles", sa.Column("experience", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "doctor_profiles",
    ...
    op.add_column(
        "doctor_profiles", sa.Column("hospital", sa.String(length=200), nullable=True)
    )
    op.add_column(
        "doctor_profiles",
    ...
    op.add_column(
        "doctor_profiles", sa.Column("photo_url", sa.String(length=512), nullable=True)
    )
    ...
    op.add_column(
        "doctor_profiles", sa.Column("license_expiry", sa.Date(), nullable=True)
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "pref_report", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "pref_email", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "pref_browser", sa.Boolean(), nullable=False, server_default=sa.text("true")
        ),
        sa.Column(
            "pref_system", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "pref_sms", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "browser_permission",
            sa.String(length=20),
