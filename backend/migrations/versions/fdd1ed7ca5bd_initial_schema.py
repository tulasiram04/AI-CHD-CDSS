...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_model_registry_model_uuid'), 'model_registry', ['model_uuid'], unique=True)
    ...
    sa.ForeignKeyConstraint(['model_artifact_id'], ['model_registry.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('clinical_predictions',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_clinical_predictions_audit_uuid'), 'clinical_predictions', ['audit_uuid'], unique=True)
    op.create_index(op.f('ix_clinical_predictions_patient_uuid'), 'clinical_predictions', ['patient_uuid'], unique=False)
    ...
    sa.Column('timestamp', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['prediction_audit_id'], ['clinical_predictions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['prediction_id'], ['clinical_predictions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_clinical_predictions_patient_uuid'), table_name='clinical_predictions')
    op.drop_index(op.f('ix_clinical_predictions_audit_uuid'), table_name='clinical_predictions')
